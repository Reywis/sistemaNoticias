    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg p-6">
                ...
                <!-- BOTONES DE ACCIÓN -->
                <div class="flex mb-4">
                    <a href="{{ route('noticias.exportar') }}" class="btn btn-success mb-3" style="margin-left:15px !important;background:#d1ecf1;border-radius:10px;color:black;padding:12px;">📥 Exportar a Excel</a>
                    <form method="POST" action="{{ route('noticias.eliminarTodas') }}" onsubmit="return confirm('¿Estás seguro de que deseas eliminar todas las noticias?')" style="margin-left:15px !important;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700" style="background:#f8d7da !important;color:black !important;">Eliminar Todas</button>
                    </form>
                    ...
                    <form method="POST" action="{{ route('noticias.eliminarLotes') }}" id="loteForm" onsubmit="return confirm('¿Estás seguro de que deseas eliminar las noticias seleccionadas?')" style="margin-left:15px !important;">
                        ...
                        <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600" style="background:#d1ecf1;border-radius:10px;color:black;padding:12px;">Eliminar Seleccionados</button>
                    </form>
                </div>
